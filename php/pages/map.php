    ...
    <main class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 100vh;">
            <a href="#" class="d-flex align-items-center mb2 mb-md-0 me-md-auto link-dark text-decoration-none">
                <img src="../../assets/imgs/icons/Book and Quill.png" class="bi pe-none me-2" width="40"
                    height="32"></img>
        ...
        <div class="row">
            <div class="cover-container d-flex w-90 p-3 mx-auto flex-column align-items-center text-white">
                ...
                var arrayLatLong = <?php echo JSON_encode($latLong);?>
                </script>
            ...
            <div class="p-3 mx-auto flex-column">
                <div class="table-responsive table-bordered"
                    ...
                    <table class="table mx-auto w-auto search-table text-light text-center" tabindex='0'
                        id="coordListing">
                        <thead>
                            <tr>
                                <th class="table_head_left_fixed"
                                    style="border: 1px solid white;background-color: #323333;width:275px;">Longitude
                                </th>
                                <th class="table_head_left_fixed"
