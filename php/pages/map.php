...
<html>
    <head>
        ...
        <!-- PHP Init -->
        <?php require_once '../classes/Maps.php'; ?>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <a href="#" class="d-flex align-items-center mb2 mb-md-0 me-md-auto link-dark text-decoration-none">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="./map.php" class="nav-link active" aria-current="page">
                ...
                <li>
                    <a href="#" class="nav-link link-dark">
                    <svg class="bi pe-none me-2" width="16" height="16" fill="Black"><use xlink:href="#dbIcon"/></svg>
                    Database
                    </a>
                </li>
            </ul>
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                <svg class="bi pe-none me-2" width="32" height="32" fill="Black"><use xlink:href="#userIcon"/></svg>
            ...
            <div class="row">
                <div class="cover-container d-flex w-90 p-3 mx-auto flex-column align-items-center text-white">
                <div id="map"></div>
                <?php 
                    $latLong = (new Maps)->getLatLong();
                    ?>
                <script type="text/javascript">var arrayLatLong = <?php echo JSON_encode($latLong);?></script>
                <script type="text/javascript" src="../../js/map.js"></script>
                </div>

                <!-- TEMPORARY FUNCTIONALITY, TO BE MODIFIED -->
                ...
                <table class="table mx-auto w-auto search-table text-light text-center" tabindex='0' id="coordListing">
                  <thead>
                    <tr>
                      ...
                      <th class="table_head_left_fixed" style="border: 1px solid white;background-color: #323333;width:275px;">Details</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        $coordinates = (new Maps)->showCoordList();
